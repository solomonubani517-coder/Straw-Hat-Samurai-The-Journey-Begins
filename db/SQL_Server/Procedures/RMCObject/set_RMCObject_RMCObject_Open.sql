       ...
       DECLARE @twRMCObjectIx_Open   BIGINT
        ...
        SELECT * INTO #Event FROM dbo.Table_Event ()
         ...
         BEGIN
                   ...
                   EXEC dbo.call_RMCObject_Validate_Orbit_Spin @SBO_CLASS_RMCOBJECT, @twRMCObjectIx, 0, @Orbit_Spin_tmPeriod, @Orbit_Spin_tmOrigin, @Orbit_Spin_dA, @Orbit_Spin_dB, @nError OUTPUT
